...
##Before Matches
Player is able to upgrade minions/towers with starting Foobar amount
...
**Upgrade 1** Generic Upgrade: Increases damage by 20%. Costs 10 DOODs
**Upgrade 2** Another Generic Upgrade: Increases uselessness by 100%. Costs 100 dolloreydoodas
...
**Upgrade 1** Increases radius by 20%. (Turns from pink to bright green) Price: 1000 Foobars **Upgrade 2** Also sets everything on fire. (Turns from bright green to dark red) Price: 1500 Foobars
